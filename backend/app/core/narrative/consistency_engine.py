...
from app.core.ai.gemini_client import generate_json

class ConsistencyEngine:
    async def analyze(self, company_name: str, statements: List[Dict[str, str]]) -> tuple[float, list[dict], list[dict]]:
